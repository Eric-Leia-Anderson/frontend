    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        {budgets.map((budget) => {
          ...
          return (
            <div key={budget.id} className="bg-white/80 backdrop-blur-sm rounded-lg shadow-md border border-blue-100 p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-blue-900">{budget.category}</h3>
                <span className="text-sm text-blue-600 capitalize">{budget.period}</span>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center text-sm">
                  <span className={isOverBudget ? 'text-red-600 font-medium' : 'text-blue-600'}>
